...
{
    public class OnboardBarberRequestValidator : AbstractValidator<OnboardBarberRequest>
    {
        public OnboardBarberRequestValidator()
        {
            RuleFor(x => x.Email)
            ...
            RuleFor(x => x.BarbershopId)
                .NotEmpty().WithMessage("Debes indicar la sede del barbero.");
        }
    }
}
